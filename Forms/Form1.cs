...
namespace task6
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateComboBoxForMethod()
        {
            ...
            {
                if (methodName == "costOfHarvest" || methodName == "get_area"
                    || methodName == "set_area" || methodName == "get_length" || methodName == "set_length"
                    || methodName == "get_width" || methodName == "set_width" || methodName == "digUp" || methodName == "sow")
                {
        ...
        private void createForm(MethodInfo methodInfo, string methodName)
        {
            ...
            button.Click += (sender, e) =>
            {
                ...
                {
                    MessageBox.Show("Oops, something happend");
                }
            };
